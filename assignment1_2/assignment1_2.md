...
sanjay@sanjay-VirtualBox:~$ ls -lrt testing/
total 20
-rwxrwxrwx 1 sanjay sanjay 266 Mar  3 11:31 myscript.sh
-rw-rw-r-- 1 sanjay sanjay   6 Mar 26 10:05 file1
-rw-rw-r-- 1 sanjay sanjay   6 Mar 26 10:05 file2
-rw-rw-r-- 1 sanjay sanjay   6 Mar 26 10:05 file3
-rw-rw-r-- 1 sanjay sanjay   6 Mar 26 10:06 file4
sanjay@sanjay-VirtualBox:~$ scp -r testing/ 21bit058@172.16.16.200:/run/media/root/Data/student/it/ug/it2021/21bit058 
...
myscript.sh                                                                                                           100%  266    26.1KB/s   00:00    
...
```plaintext
[21bit058@SANlinux ~]$ls
ar  c  cpp  csharp  DBMS  ds  embed  eur  foss  html  ITT  java  ML  mobile  Network  os  Soft  testing  thinclient_drives  webtech
[21bit058@SANlinux ~]$ls -lrt testing
total 20
-rw-r--r--. 1 21bit058 it-ug-2021   6 Mar 26 10:20 file4
-rwxr-xr-x. 1 21bit058 it-ug-2021 266 Mar 26 10:20 myscript.sh
-rw-r--r--. 1 21bit058 it-ug-2021   6 Mar 26 10:20 file3
-rw-r--r--. 1 21bit058 it-ug-2021   6 Mar 26 10:20 file1
-rw-r--r--. 1 21bit058 it-ug-2021   6 Mar 26 10:20 file2
[21bit058@SANlinux ~]$cd testing
[21bit058@SANlinux testing]$cat file3
Hello
...
sanjay@sanjay-VirtualBox:~$ ls -lrt testing2
total 20
-rw-rw-r-- 1 sanjay sanjay   6 Mar 26 10:14 file1
-rwxrwxr-x 1 sanjay sanjay 266 Mar 26 10:14 myscript.sh
-rw-rw-r-- 1 sanjay sanjay   6 Mar 26 10:14 file2
-rw-rw-r-- 1 sanjay sanjay   6 Mar 26 10:14 file4
-rw-rw-r-- 1 sanjay sanjay   6 Mar 26 10:14 file3
sanjay@sanjay-VirtualBox:~$ rsync -avz testing2/ 21bit058@172.16.16.200:/run/media/root/Data/student/it/ug/it2021/21bit058/testing2 
...
[21bit058@SANlinux ~]$ls -lrt testing2
total 20
-rw-rw-r--. 1 21bit058 it-ug-2021   6 Mar 26 10:14 file1
-rwxrwxr-x. 1 21bit058 it-ug-2021 266 Mar 26 10:14 myscript.sh
-rw-rw-r--. 1 21bit058 it-ug-2021   6 Mar 26 10:14 file2
-rw-rw-r--. 1 21bit058 it-ug-2021   6 Mar 26 10:14 file4
-rw-rw-r--. 1 21bit058 it-ug-2021   6 Mar 26 10:14 file3
[21bit058@SANlinux ~]$cd testing2
[21bit058@SANlinux testing2]$cat file2
Hello
...
```plaintext
root@sanjay-VirtualBox:/home/sanjay# sudo apt install vsftpd -y
Reading package lists... Done
Building dependency tree... Done
Reading state information... Done
vsftpd is already the newest version (3.0.5-0ubuntu1).
0 upgraded, 0 newly installed, 0 to remove and 70 not upgraded.
root@sanjay-VirtualBox:/home/sanjay# sudo nano /etc/vsftpd.conf
root@sanjay-VirtualBox:/home/sanjay# sudo systemctl restart vsftpd
root@sanjay-VirtualBox:/home/sanjay# sudo systemctl enable vsftpd
Synchronizing state of vsftpd.service with SysV service script with /lib/systemd/systemd-sysv-install.
Executing: /lib/systemd/systemd-sysv-install enable vsftpd
root@sanjay-VirtualBox:/home/sanjay# sudo systemctl status vsftpd
● vsftpd.service - vsftpd FTP server
     Loaded: loaded (/lib/systemd/system/vsftpd.service; enabled; vendor preset: enabled)
     Active: active (running) since Tue 2026-02-26 12:35:15 IST; 1min 20s ago
...
Mar 26 12:35:15 sanjay-VirtualBox systemd[1]: Starting vsftpd FTP server...
Mar 26 12:35:15 sanjay-VirtualBox systemd[1]: Started vsftpd FTP server.

```

### Client PUT and GET:
```plaintext
C:\Users\sanjay Pethuram K>ftp 192.168.56.102
...
ftp> put "C:\Users\sanjay Pethuram K\Downloads\eUR\file.txt"
200 PORT command successful. Consider using PASV.
150 Ok to send data.
...
### SETUP:
```plaintext
root@sanjay-VirtualBox:/home/sanjay# sudo apt install openssh-server -y
Reading package lists... Done
Building dependency tree... Done
Reading state information... Done
openssh-server is already the newest version (1:8.9p1-3ubuntu0.11).
0 upgraded, 0 newly installed, 0 to remove and 70 not upgraded.
root@sanjay-VirtualBox:/home/sanjay# sudo systemctl enable ssh
sudo systemctl start ssh
Synchronizing state of ssh.service with SysV service script with /lib/systemd/systemd-sysv-install.
Executing: /lib/systemd/systemd-sysv-install enable ssh
root@sanjay-VirtualBox:/home/sanjay# sudo systemctl start ssh
root@sanjay-VirtualBox:/home/sanjay# sudo nano /etc/ssh/sshd_config
root@sanjay-VirtualBox:/home/sanjay# sudo systemctl restart ssh
root@sanjay-VirtualBox:/home/sanjay# sudo systemctl stat ssh
Unknown command verb stat.
root@sanjay-VirtualBox:/home/sanjay# sudo systemctl status ssh
● ssh.service - OpenBSD Secure Shell server
     Loaded: loaded (/lib/systemd/system/ssh.service; enabled; vendor preset: enabled)
     Active: active (running) since Tue 2026-02-26 12:31:58 IST; 21s ago
       Docs: man:sshd(8)
             man:sshd_config(5)
...
Mar 26 12:31:58 sanjay-VirtualBox systemd[1]: Starting OpenBSD Secure Shell server...
Mar 26 12:31:58 sanjay-VirtualBox sshd[4606]: Server listening on 0.0.0.0 port 22.
Mar 26 12:31:58 sanjay-VirtualBox sshd[4606]: Server listening on :: port 22.
Mar 26 12:31:58 sanjay-VirtualBox systemd[1]: Started OpenBSD Secure Shell server.
...
```plaintext
C:\Users\sanjay Pethuram K>sftp ftpuser@192.168.56.102
ftpuser@192.168.56.102's password:
Connected to 192.168.56.102.
sftp> ls
hello.txt   snap
sftp> put "C:\Users\sanjay Pethuram K\Downloads\eUR\file.txt"
Uploading C:/Users/sanjay Pethuram K/Downloads/eUR/file.txt to /home/ftpuser/file.txt
...
Installing:
root@sanjay-VirtualBox:/home/sanjay# sudo apt-get install tcpdump

To capture packets on interface, we can use the -i option:
root@sanjay-VirtualBox:/home/sanjay# sudo tcpdump -i enp0s3
...
root@sanjay-VirtualBox:/home/sanjay# sudo tcpdump -i enp0s3 -w test.pcap
tcpdump: listening on enp0s3, link-type EN10MB (Ethernet), snapshot length 262144 bytes
5 packets captured
5 packets received by filter
0 packets dropped by kernel
root@sanjay-VirtualBox:/home/sanjay# ls
...
```plaintext
root@sanjay-VirtualBox:/home/sanjay# ping -c 10 192.168.56.102
PING 192.168.56.102 (192.168.56.102) 56(84) bytes of data.
64 bytes from 192.168.56.102: icmp_seq=1 ttl=64 time=0.126 ms
...
rtt min/avg/max/mdev = 0.033/0.050/0.126/0.026 ms
```
-s is used to set the size of the packet
```plaintext
root@sanjay-VirtualBox:/home/sanjay# ping -s 100 192.168.56.102
...
```plaintext
root@sanjay-VirtualBox:/home/sanjay# arp -a
? (192.168.56.100) at 08:00:27:c7:9a:9c [ether] on enp0s3
root@sanjay-VirtualBox:/home/sanjay# 
...
```plaintext
root@sanjay-VirtualBox:/home/sanjay# ip route
169.264.0.0/16 dev enp0s3 scope link metric 1000 
...
This message is sent to the special IP address 265.265.265.265, which means it is broadcast to all devices on the local network.
...
```plaintext
root@sanjay-VirtualBox:/home/sanjay# ssh 21bit058@172.16.16.200
...
[21bit058@SANlinux ML]$cat ex6a.txt
import numpy as np
import pandas as pd
